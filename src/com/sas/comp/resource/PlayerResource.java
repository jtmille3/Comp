...
public class PlayerResource {
	...
	public Collection<Player> findAll() {
		Collection<Player> players = Hibernate.getInstance()
				.createQuery("SELECT distinct p FROM players p JOIN FETCH p.teamPlayers ORDER BY p.id", Player.class).getResultList();
