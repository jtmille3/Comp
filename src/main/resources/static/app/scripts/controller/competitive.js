...
define(function(require) {
	...
	return {
		init: function(competitive) {
			...
			var compTemplate = window.comp['src/main/resources/static/app/templates/comp.html'];
            ...
            this.getWeather(function(weather) {
                var weatherTemplate = window.comp['src/main/resources/static/app/templates/weather.html'];
		...
		generatePlayerDialog: function(player) {
			var playerTemplate = window.comp['src/main/resources/static/app/templates/player.html'];
		...
		selectedChampion: function(season, teamId) {
			...
			var championRosterTemplate = window.comp['src/main/resources/static/app/templates/champion_roster.html'];
