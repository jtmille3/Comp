...
define(function(require) {
	...
	return {
		render: function() {
			var self = this;
			var passwordTemplate = window.comp['src/main/resources/static/app/templates/password.html'];
		...
		login: function() {
			...
			$.ajax({
				...
				type: 'POST',
				success: function() {
					var adminTemplate = window.comp['src/main/resources/static/app/templates/admin.html'];
		...
		renderGames: function(games) {
			var self = this;
			var scheduleTemplate = window.comp['src/main/resources/static/app/templates/schedule.html'];
			...
			$('.played').click(function() {
				...
				var scoreTemplate = window.comp['src/main/resources/static/app/templates/score.html'];
		...
		selectedGame: function(game) {
			...
			$.get('/service/games/'+game.id+'/players', function(players) {
				...
				var scoresTemplate = window.comp['src/main/resources/static/app/templates/scores.html'];
